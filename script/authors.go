...
const authorsHeader = `# This is the official list of authors for copyright purposes.
#
...
func main() {
	...
	if err := ioutil.WriteFile("thanks.txt", []byte(replacement), 0644); err != nil {
		log.Fatal(err)
	}
...
func getAuthors() []author {
	...
	for _, line := range lines {
		...
		author.name = strings.Trim(author.name, "*/_`")
		authors = append(authors, author)
	}
	return authors
}
