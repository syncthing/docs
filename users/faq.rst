...
If you've forgotten/lost the GUI password, you can reset it to blank by deleting the **<user>** and **<password>** XML tags from the **<gui>** block in config.xml. The location of the file depends on OS and is described in the configuration documentation.
...
After this the GUI can be accessed without authentication. No restart of Syncthing or refresh of the browser is *required*, but for consistent results it is recommended.
